...
public class OutputView {
    ...
    public void printGiveawayMenu(Map<String, Integer> giveawayComposition) {
        ...
        if (giveawayComposition.isEmpty()) {
            printNone();
            return;
        }
    ...
    public void printBenefitDetails(Map<String, Integer> benefitDetails) {
        ...
        benefitDetails.keySet()
                .forEach(name -> printDetail(name, benefitDetails.get(name)));
    }
    ...
    private void printDetail(String name, Integer price) {
        System.out.println(name + ": " + MONEY_FORMATTER.format(-price) + UNIT_OF_MONEY);
    }
}
